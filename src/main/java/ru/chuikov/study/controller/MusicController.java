...
public class MusicController {
    ...
    private final TypeOfMedia typeOfMedia = TypeOfMedia.audio;

    public MusicController(FileService fileService, Tika tika, UserService userService) {
    ...
    public ResponseEntity addMusic(@RequestParam("file") MultipartFile multipartFile, User user) {
        try {
            if (!tika.detect(multipartFile.getInputStream()).contains(typeOfMedia.name())) {
    ...
    public ResponseEntity getListMusicByUserId(@PathVariable Long id, User user) {
    ...
    public ResponseEntity getListMusicByUser(@PathVariable("id") String id, User user) {
        try {
    ...
    public ResponseEntity deleteMusic(@PathVariable("id") String id, User user) {
